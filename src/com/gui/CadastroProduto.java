...
public class CadastroProduto extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        ftfPrecoCompra.setValue(new Double(0.0));
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        ftfPrecoVenda.setValue(new Double(0.0));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
    ...
    private void limpaFormulario() {
        produto = null;
        ftfNome.setValue("");
        ftfPrecoCompra.setValue(0.0);
        ftfPrecoVenda.setValue(0.0);
    }
    ...
    private boolean validarFormulario() {
        ...
        Double precoCompra = (Double) ftfPrecoCompra.getValue();
        Double precoVenda = (Double) ftfPrecoVenda.getValue();

        if (precoVenda <= precoCompra) {
            JOptionPane.showMessageDialog(this, "O preço de venda deve ser maior que o preço de compra.", "Alerta", JOptionPane.WARNING_MESSAGE);
            ftfPrecoVenda.requestFocus();
            return false;
}
